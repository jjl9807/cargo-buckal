...
git_fetch(
    name = "vendor",
    repo = "https://github.com/web3infra-foundation/git-internal.git",
    rev = "65b910d7571f36aa231958992e005a7a1c0838e9",
)
...
rust_library(
    ...
    deps = [
        ...
        "//third-party/rust/crates/tempfile/3.26.0:tempfile",
